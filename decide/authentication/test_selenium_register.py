...
class RegisterTestCase(StaticLiveServerTestCase):
    ...
    def test_register_ok(self):
        ...
        time.sleep(0.5)
        self.driver.find_element(By.ID, "id_sex").find_element(By.XPATH, "//option[. = 'Otro']").click()
        time.sleep(0.5)
        self.driver.find_element(By.ID, "id_age").clear()
        self.driver.find_element(By.ID, "id_age").send_keys("34")
        time.sleep(0.5)
        self.driver.find_element(By.ID, "id_status").find_element(By.XPATH, "//option[. = 'Viudo']").click()
        time.sleep(0.5)
